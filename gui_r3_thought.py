...
# -*- coding: utf-8 -*-
"""
zhangy chat - 图形界面 (R3 思考可见版)
思考过程实时显示，类似 MiniMind
"""
...
from zhangy_chat.assistant_r3_thought import Assistant
...
class ZhangyChatGUI:
    ...
    def __init__(self, root):
        self.root = root
        self.root.title("zhangy chat R3 - 思考可见版")
    ...
    def _create_widgets(self):
        ...
        # 左侧：思考过程显示区
        thought_frame = tk.LabelFrame(main_frame, text="💭 思考过程", font=("Microsoft YaHei", 10), bg="#ecf0f1")
        ...
        tk.Label(input_frame, text="输入问题:", font=("Microsoft YaHei", 10), bg="#ecf0f1").pack(anchor=tk.W)

        self.input_text = tk.Text(input_frame, height=4, font=("Microsoft YaHei", 10), padx=5, pady=5)
        ...
        tk.Button(
            btn_frame, text="清空", command=self.clear_chat,
        ...
        tk.Checkbutton(
            btn_frame, text="显示思考过程",
            variable=self.show_thought_var,
            bg="#ecf0f1", font=("Microsoft YaHei", 10)
        ...
        self.tip_label = tk.Label(
            status_frame, text=self.assistant.get_daily_tip(), font=("Microsoft YaHei", 9),
            bg="#2c3e50", fg="#2ecc71"
        )
    ...
    def send_message(self):
        ...
        self._add_chat_message("用户", user_input, "#3498db")
    ...
    def _process_response(self, user_input: str, show_thought: bool):
        ...
        try:
            ...
            # 更新聊天区
            self.root.after(0, lambda: self._add_chat_message(self.name, response, "#2c3e50"))
        except Exception as e:
            self.root.after(0, lambda: self._add_chat_message("系统", f"错误：{e}", "#e74c3c"))
        finally:
