        ...
        try:
            ...
            if model_path:
                ...
                try:
                    ...
                    # 加载模型 - 使用 MiniMind 原生方式
                    try:
                        # 尝试使用 MiniMind 原生加载
                        from .minimind_model import load_model as load_minimind
                        self.model = load_minimind(model_path, self.device)
                        ...
                        print(f"[zhangy-chat] MiniMind 模型加载失败：{e}")
                        print("[zhangy-chat] 将使用知识库模式")
                        return False
